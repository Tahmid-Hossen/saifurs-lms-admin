    ...
    <div class="page-content-wrapper">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <!-- form start -->
                <form class="horizontal-form" id="student_form" role="form" method="POST" action="{{ route('students.update',$student->id) }}" enctype="multipart/form-data">
                   @csrf
                    @method('PUT')
...
{{--
    ...
    <script>
        var selected_state_id = '{{old("state_id", (isset($student)?$student->state_id:null))}}';
        var selected_city_id = '{{old("city_id", (isset($student)?$student->city_id:null))}}';
        var selected_branch_id = '{{old("branch_id", (isset($student)?$student->branch_id:null))}}';
        getProvinceList();
        getCityList();
        ...
        function getCityList(){
            var country_id = $('#country_id').val();
            var state_id = $('#state_id').val() || '{{old("present_state_id", (isset($student)?$student->state_id:null))}}';
            var pickToken = '{{csrf_token()}}';
