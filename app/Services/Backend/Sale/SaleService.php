...
class SaleService
{
    ...
    public function storeSale(array $input, array $items)
    {
        ...
        try {
            ...
            try {
                ...
                $saleModel->refresh();
                $transaction_id = $this->generateTransactionId($saleModel->id,$input['company_id']);
     ...
     * @throws Exception
     */
    public function generateTransactionId($saleId,$companyId): ?string
    {
        ...
        try {
            ...
            $transaction_id = str_pad($sale_id, 7, '0', STR_PAD_LEFT);
