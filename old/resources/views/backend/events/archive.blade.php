    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            <div class="box box-default collapsed-box">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                    <form class="horizontal-form" role="form" method="GET" action="{{ route('events.archive') }}">
                        @csrf
                        <input type="hidden" name="event_current_status[0]" value="expired">
                        <div class="row">
            ...
            <!-- /.box -->
            <div class="box">
                {!! \CHTML::formTitleBox($caption = 'List of All Expired Events', 'null', $routeName = null, $buttonClass = '', $buttonIcon = '') !!}
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column"
                            ...
                            @foreach ($datas as $data)
                                <tr class="odd gradeX">
                                    ...
                                    <td class="text-center">{!! \Utility::getDateTimeHuman(\Carbon\Carbon::parse($data->event_end)) !!}</td>
                                    ...
                                    <td>{!! \CHTML::actionButton($reportTitle = '..', $routeLink = '#', $data->id, $selectButton = ['showButton'], $class = 'btn-icon btn-circle ', $onlyIcon = 'yes', $othersPram = []) !!}</td>
                                </tr>
                            @endforeach
                        </table>
                    </div>
