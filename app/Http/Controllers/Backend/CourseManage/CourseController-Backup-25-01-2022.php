...
//		dd($request->all());
    ...
    public function edit($id)
    {
        try {
            ...
            return view('backend.course.course.edit', compact('branches','course', 'tags', 'companies', 'course_categories', 'course_sub_categories', 'course_child_categories','imagepath'));
        } catch (\Exception $e) {
            \Log::error($e->getMessage());
            flash('Course data not found!')->error();
            return redirect()->route('course.index');
