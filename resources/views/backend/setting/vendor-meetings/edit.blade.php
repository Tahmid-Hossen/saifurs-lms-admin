        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <!-- form start -->
                    <form class="horizontal-form" id="vendor_meeting_form" role="form" method="POST" action="{{ route('vendor-meetings.update', $vendorMeeting->id) }}" enctype="multipart/form-data">
                       @csrf
                        @method('PUT')
