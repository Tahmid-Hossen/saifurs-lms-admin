...
/**
 * @class App\Notifications\Backend\Announcement\AssignmentAnnouncementCreatedNotification
 * @package App\Notifications\Backend\Announcement
 *
 */
class AssignmentAnnouncementCreatedNotification extends Notification
{
    use Queueable;
    ...
    public function toArray($notifiableUser)
    {
        return [
            'title' => "Announcement",
            'body' => "There is a new assignment announcement for you.",
    ...
    public function toPush($notifiableUser): PushMessage
    {
        ...
        if (!empty($FCMToken)) :
            $pushMessage->to($FCMToken)
                ->title("Announcement")
                ->line("There is a new assignment announcement for you.")
                ->image('/assets/svg/assignment.svg')
                ->type("assignment-announcement")
