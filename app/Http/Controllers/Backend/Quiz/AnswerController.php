    ...
    */
    ...
    public function index(Request $request)
    {
        try {
            ...
            return view('backend.quiz.answer.index', compact('question_answers', 'request', 'questions', 'companies', 'courses'));
        } catch (\Exception $e) {
    ...
    public function create()
    {
        try {
            ...
            return view('backend.quiz.answer.create', compact('questions', 'companies', 'courses', 'course_chapters', 'course_classes'));
        } catch (\Exception $e) {
            flash('Something wrong with Answer Data!')->error();
            return Redirect::to('/backend/answers');
        }
    }
    ...
    public function show($id)
    {
        try {
            ...
            // dd($question_answer);
            return view('backend.quiz.answer.show', compact('question_answer'));
        } catch (\Exception $e) {
    ...
    public function edit($id)
    {
        try {
            ...
            return view('backend.quiz.answer.edit', compact('question_answer', 'questions', 'companies', 'courses', 'course_chapters', 'course_classes'));
        } catch (\Exception $e) {
            flash('Answer data not found!')->error();
            return redirect()->route('answers.index');
        }
    ...
    public function pdf(Request $request)
    {
        try {
            ...
            return view('backend.quiz.answer.pdf', compact('question_answers'));
        } catch (\Exception $e) {
            flash('Answer table not found!')->error();
            return Redirect::to('/backend/answers');
        }
