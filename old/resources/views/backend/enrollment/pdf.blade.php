        ...
        foreach($enrollments as $enrollment):
            ...
            $html .= '<tbody>';
                $html .= '<tr>';
                    ...
                    $html .= '<td>'.\Carbon\Carbon::parse($enrollment->created_at)->format(config('app.date_format2')).'</td>';
                $html .= '</tr>';
            $html .= '</tbody>';
        endforeach;
    endif;
...
*/
    $mpdf->SetHTMLHeader('
        <table width="100%">
            ...
            <tr><td align="center"><b>Course Enrollment List For '.date('F Y').'</b></td></tr>
        </table><br><br>
    ');
    $mpdf->AddPage('L', 'A4');
    ...
    ');
    $mpdf->WriteHTML(($html));
    $mpdf->Output('Course Enrollment Report For '.date('F Y').'.pdf', 'D');
@endphp
