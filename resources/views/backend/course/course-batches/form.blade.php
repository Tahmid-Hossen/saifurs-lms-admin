...
{{--        </div>--}}
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                @if (!empty($selectedbranch) && count($selectedbranch) > 0)
                <select name="branch_id[]" id="branch_id" class="form-control select2" multiple>
                    <option value="">Select Branch</option>
                        @foreach($selectedbranch as $sbranch)
                            <option value="{{ $sbranch->id }}" selected>{{ $sbranch->branch_name }}</option>
                        @endforeach
                </select>
                @else
                    <select name="branch_id[]" id="branch_id" class="form-control select2" multiple>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                @if (isset($selectedcourses) && ($selectedcourses != ""))
                    <select name="course_id" id="course_id" class="form-control" required>
                        {{--<option value="" @if (isset($courseBatch) && ($courseBatch->company_id === "")) selected @endif>
                            Select Course
                        </option>--}}
                        <option value="{{ $selectedcourses->id }}" selected>{{ $selectedcourses->course_title }}</option>
                    </select>
                    <input type="hidden" name="course_id" value="{{ $selectedcourses->id }}">
                @else
                    <select name="course_id" id="course_id" class="form-control" required>
                        <option value="" @if (isset($courseBatch) && ($courseBatch->company_id === "")) selected @endif>
                            Select Course
                        ...
                        @foreach($courses as $course)
                            <option value="{{$course->id}}" @if (isset($courseBatch) && ($courseBatch->course_id === $course->id)) @endif>{{$course->course_title}}</option>
                        @endforeach
                    </select>
                @endif
                ...
                <div class="col-md-6">
                    <div class="img-thumbnail text-center">
                        <img class="img-responsive" style="display: inline-block; height: 178px;"
                             ...
                             src="{{isset($courseBatch->course_batch_logo)?URL::to('/public/'.$courseBatch->course_batch_logo):config('app.default_image')}}"
