...
{{--        <div class="col-md-4">
        ...
        <div class="col-md-6">
            <div class="form-group">
                {!! \Form::nLabel('chapter_id', 'Chapter', true) !!}
    ...
    <div class="row">
        <div class="col-md-12">
        <div class="form-group">
                {!! \Form::nLabel('class_name', 'Class Name', true) !!}
                <input
                    type="text"
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <textarea id="class_short_description" name="class_short_description" rows="5"
                          ...
                          placeholder="Enter Class Short details">{{ old('class_short_description', isset($course_class->class_short_description) ? $course_class->class_short_description: null) }}</textarea>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <textarea id="class_description" name="class_description" rows="5"
                          ...
                          placeholder="Enter Class Description">{{ old('class_description', isset($course_class->class_description) ? $course_class->class_description: null) }}</textarea>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input
                    ...
                    name="class_file"
                    id="class_file"
                    placeholder="Enter Course Class File"
        ...
        <div class="col-md-6">
            ...
            <div class="form-group" id="url_box">
                ...
                <input type="text"
                       ...
                       placeholder="Enter Class URL: https://www.youtube.com/">
    ...
    <div class="row">
        {{-- <div class="col-md-4">
            <div class="form-group">
                {!! \Form::nLabel('class_type', 'Class Type', false) !!}
