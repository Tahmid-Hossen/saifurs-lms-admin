        ...
        foreach($learns as $learn):
            ...
            $html .= '<tbody>';
                $html .= '<tr>';
                    ...
                    $html .= '<td>'.\Carbon\Carbon::parse($learn->created_at)->format('M d, Y h:i:s A').'</td>';
                $html .= '</tr>';
            $html .= '</tbody>';
        endforeach;
    endif;
...
*/    $mpdf->SetHTMLHeader('
        <table width="100%">
            ...
            <tr><td align="center"><b>Course Learn List For '.date('F Y').'</b></td></tr>
        </table><br><br>
    ');
    $mpdf->AddPage('L', 'A4');
    ...
    ');
    $mpdf->WriteHTML(($html));
    $mpdf->Output('Course Learn Report For '.date('F Y').'.pdf', 'D');
@endphp
