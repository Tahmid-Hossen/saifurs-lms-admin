    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            <div class="box box-default collapsed-box">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                    <form class="horizontal-form" role="form" method="GET" action="{{ route('students.index') }}">
                        <div class="row">
                            <div class="col-md-4">
            ...
            <div class="box">
                ...
                <div class="box-body no-padding">
                    ...
                    <table
                        class="table table-striped table-responsive table-bordered table-hover table-checkable order-column"
                        width="100%">
                        <thead>
                        <tr>
                            <th> Reg. No</th>
                        ...
                        @foreach($students as $sl => $student)
                            <tr>
                                <td>{{isset($student)?$student->student_id:null}}</td>
                                <td>{{$student->user->username}}</td>
                                <td>{{$student->user->name}}</td>
                                <td>{!!$student->mobile_phone !!}</td>
                                <td>{{strtoupper($student->gender)}}</td>
                                <td>{{\Carbon\Carbon::parse($student->date_of_enrollment)->format(config('app.date_format2'))}}</td>
                                <td>{!! \CHTML::flagChangeButton($student->user, 'status', \Utility::$statusText) !!}</td>
                                <td class="tbl-date">{{$student->created_at->format(config('app.date_format2'))}}</td>
