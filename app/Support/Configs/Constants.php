...
class Constants
{
    ...
    public static $faq_status = [
        'INACTIVE',
        'ACTIVE'
    ];
    public static $googleApiKey_status = [
        'INACTIVE',
        'ACTIVE'
    ];
    public static $book_price_list_status = [
        'INACTIVE',
        'ACTIVE'
    ];
    public static $branch_location_status = [
        'INACTIVE',
        'ACTIVE'
    ];

    public static $course_learn = [
        'INACTIVE',
        'ACTIVE'
    ];

    public static $course_syllabus = [
        'INACTIVE',
        'ACTIVE'
    ];
