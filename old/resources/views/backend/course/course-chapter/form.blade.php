...
{{--        <div class="col-md-6">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                {!! \Form::nLabel('chapter_title', 'Chapter Title', true)!!}
                <input
                    type="text"
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <textarea id="chapter_short_description" name="chapter_short_description" rows="5"
                          ...
                          placeholder="Enter Course Chapter Short details">{{ old('chapter_short_description', isset($course_chapter->chapter_short_description) ? $course_chapter->chapter_short_description: null) }}</textarea>
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <textarea id="chapter_description" name="chapter_description" rows="5"
                          ...
                          placeholder="Enter Course Chapter details">{{ old('chapter_description', isset($course_chapter->chapter_description) ? $course_chapter->chapter_description: null) }}</textarea>
