...
// Course Question
Breadcrumbs::for('course-questions.index', function ($breadcrumbs) {
    $breadcrumbs->parent('dashboard');
    $breadcrumbs->push('Course-questions', route('course-questions.index'));
});

Breadcrumbs::for('course-questions.create', function ($breadcrumbs) {
    $breadcrumbs->parent('course-questions.index');
    $breadcrumbs->push('Create', route('course-questions.create'));
});

Breadcrumbs::for('course-questions.edit', function ($breadcrumbs) {
    $breadcrumbs->parent('course-questions.index');
    $breadcrumbs->push('Edit', route('course-questions.edit', 0));
});

Breadcrumbs::for('course-questions.show', function ($breadcrumbs) {
    $breadcrumbs->parent('course-questions.index');
    $breadcrumbs->push('Details', route('course-questions.show', 0));
});

Breadcrumbs::for('course-questions.destroy', function ($breadcrumbs) {
    $breadcrumbs->push('Delete Course Question', route('course-questions.create'));
});
// Course Question Answer
Breadcrumbs::for('question-answers.index', function ($breadcrumbs) {
    $breadcrumbs->parent('dashboard');
    $breadcrumbs->push('question-answers', route('question-answers.index'));
});

Breadcrumbs::for('question-answers.create', function ($breadcrumbs) {
    $breadcrumbs->parent('question-answers.index');
    $breadcrumbs->push('Create', route('question-answers.create'));
});

Breadcrumbs::for('question-answers.edit', function ($breadcrumbs) {
    $breadcrumbs->parent('question-answers.index');
    $breadcrumbs->push('Edit', route('question-answers.edit', 0));
});

Breadcrumbs::for('question-answers.show', function ($breadcrumbs) {
    $breadcrumbs->parent('question-answers.index');
    $breadcrumbs->push('Details', route('question-answers.show', 0));
});

Breadcrumbs::for('question-answers.destroy', function ($breadcrumbs) {
    $breadcrumbs->push('Delete Answer', route('question-answers.create'));
});
