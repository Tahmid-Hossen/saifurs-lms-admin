            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        @php
                            $start_date = (isset($vendorMeeting) && !is_null($vendorMeeting->vendor_meeting_start_time))
                            ? $vendorMeeting->vendor_meeting_start_time->format('Y-m-d H:i:s')
                            : date('Y-m-d H:i:s');

                            $end_date = (isset($vendorMeeting) && !is_null($vendorMeeting->vendor_meeting_end_time))
                            ? $vendorMeeting->vendor_meeting_end_time->format('Y-m-d H:i:s')
                            : date('Y-m-d H:i:s');
