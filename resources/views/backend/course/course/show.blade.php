...
{{--                                    <tr>
                                        <th>Company:</th>
                                        <th style="color: #00a65a">{!! $course->company->company_name ?? '' !!}</th>
                                    </tr>
                                    @if(isset($course->branch->branch_name) && $course->branch->branch_name != '')
                                    <tr>
                                        <th>Branch:</th>
                                        <th style="color: #00a65a">{!! $course->branch->branch_name ?? '' !!}</th>
                                    </tr>
                                    @endif--}}
                                    ...
                                    <tr>
                                        <th>Course Option:</th>
                                        <th>{!! $course->course_option ?? '' !!} <i class="fa fa-arrow-right"></i> {!! $course->course_type ?? '' !!} </th>
                                    </tr>
                                    @elseif(isset($course->course_option) && $course->course_option == 'Offline')
                                    <tr>
                                        <th>Course Option:</th>
                                        <th>{!! $course->course_option ?? '' !!}</th>
                                    </tr>
                                    @endif
                                    {{-- @if(isset($course->course_type) && $course->course_type != '')
                                    <tr>
                                        <th>Course Option:</th>
                                    ...
                                    <tr>
                                        ...
                                        <th style="color: #76767f">{!!  $course->courseCategory->course_category_title ?? '' !!}</th>
                                    </tr>
                                    <tr>
                                        <th>Course Sub Category:</th>
                                        <th style="color: #76767f">{!! $course->courseSubCategory->course_sub_category_title ?? '' !!}</th>
                                    </tr>
                                    <tr>
                                        <th>Course Child Category:</th>
                                        <th style="color: #76767f">{!! $course->courseChildCategory->course_child_category_title ?? '' !!}</th>
                                    </tr>
                                    <tr>
                                        <th>Course Type:</th>
                                        <th>
                                    ...
                                    <tr>
                                        <th>Total Class No:</th>
                                        <th>{{ isset($course->total_class_no)?$course->total_class_no:null }}</th>
                                    </tr>
                            ...
                            <div class="col-md-6">
                                <table class="table table-bordered">
                                    <tr>
                                        ...
                                        <th>
                                            @if (isset($course->course_image))
                                                <img src="{{ asset('/public/'.$imagepath.$course->course_image) }}"
                                            ...
                                            @if (isset($course->course_video))
                                                <div id="video-player">
                                                    <video width="100%" height="300px" controls>
                                                        <source src="{{ url('/').$course->course_video }}"
                                                                type="video/mp4">
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            @if($course->course_language == 'EN' || mb_strtolower($course->course_language) == 'english')
                                                <p>ENGLISH</p>
                                            @elseif($course->course_language == 'BA' || mb_strtolower($course->course_language) == 'bangla')
                                                <p>BANGLA</p>
                                            @else
                                                <p>N/A</p>
                                            @endif
