    ...
    $html .= '<table width="100%" style="padding: 2px; font-size:12px;" cellpadding="0" cellspacing="0" border="1">';
        $html .= '<thead>';
            $html .= '<tr>';
                ...
                $html .= '<th align="center"><b>Course Sub Category Title</b></th>';
   ...
   //            <tr><td align="center"><img src="'.$company_logo.'" width="50" alt=""></td></tr>
    $mpdf->SetHTMLHeader('
        <table width="100%">
            ...
            <tr><td align="center"><b>Course Sub Category List</b></td></tr>
        </table><br><br>
    ');
    $mpdf->AddPage('L', 'A4');
    ...
    ');
    $mpdf->WriteHTML(($html));
    $mpdf->Output('Course Sub Category Report For '.date('F Y').'.pdf', 'D')
@endphp
