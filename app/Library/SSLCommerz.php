...
class SSLCommerz
{
    ...
    public function __construct()
    {
        ...
        $this->setStoreId($this->config['mode']['store_id']);
        $this->setStorePassword($this->config['mode']['store_password']);
    }
     ...
     */
    public function formatResponse($response, string $type = 'checkout', string $pattern = 'json')
    {
