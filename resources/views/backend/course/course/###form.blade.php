...
old('course_short_description', ($course->course_short_description) ??  null), true) !!}
            ...
            <div class="form-group">
                ...
                <select name="course_option" id="course_option" class="form-control view-color"
                    ...
                    @foreach(\App\Support\Configs\Constants::$class_types as $c_type)
                        <option value="{{$c_type}}"
                                @if (isset($course) && ($course->course_option === $c_type)) selected @endif onlo
        ...
        <div class="col-md-4">
            <div class="form-group" id="branch_show">
                ...
                <select name="branch_id" id="branch_id" class="form-control">
                    <option value="" @if (isset($course) && ($course->branch_id === "")) selected @endif>Select Branch</option>
                </select>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group">
                <label id="returnmsg">Image</label>
               {{-- <input
                    type="file"
                    class="form-control"
                    name="course_image"
                ...
                @if (isset($course->course_image))
                    <img src="{{ asset($imagepath.$course->course_image) }}" id="preview_img" alt="course image"
...
@push('scripts')
    ...
    <script>
        ...
        // Course Option
        function showInstructor(element) {
