                                    ...
                                    <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
                                        ...
                                        <tr>
                                            <td style="width:200px;">
                                                ...
                                                <img height="auto" src="{{ asset('/assets/img/logo.png') }}"
                            ...
                            <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    ...
                                    <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:14px;line-height:20px;text-align:left;color:#525252;">
                                        Best regards,<br><br>
                                        The S@ifur's Support Team<br>
                                        <br>
                                        <a href="https://www.saifurs.com.bd/" style="color:#2F67F6; text-decoration: none">S@IFUR’S PVT. LTD</a><br>
                                        <a href="mailto:info@saifurs.com.bd" style="color:#2F67F6">info@saifurs.com.bd</a><br>
                                    </div>
