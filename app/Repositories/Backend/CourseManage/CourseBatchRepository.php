...
class CourseBatchRepository extends Repository
{
    ...
    public function courseBatchFilterData($filters): Builder
    {
        ...
        $query->select([
            ...
            'course_batches.*',
            \DB::raw('IFNULL(IF(course_batches.course_batch_logo REGEXP "https?", course_batches.course_batch_logo, CONCAT("'.url('/public/').'",course_batches.course_batch_logo)), CONCAT("'.url('/').'","/assets/img/default.png")) AS course_batch_logo'),
