...
class CourseBatchService
{
     ...
     * @return false|mixed
     */
    public function createCourseBatch($input, $course, $branch_id=null)
    {
        try {
            ...
            if (isset($input['batch_class_days'])) {
                $input['batch_class_days'] = implode(',', array_keys($input['batch_class_days']));
            }
