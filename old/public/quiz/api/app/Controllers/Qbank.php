...
class Qbank extends BaseController
{
    ...
    public function getQuestion()
    {
        ...
        if ($id == null) {
            $json_arr['status'] = "failed";
            $json_arr['message'] = "Question id required";
            return json_encode($json_arr);
        }
        ...
        $json_arr['status'] = "success";
        $json_arr['message'] = "";
        $json_arr['data'] = $question;
        $json_arr['options'] = $options;
        return json_encode($json_arr);
    ...
    public function remove()
    {
        ...
        $query = $db1->query($sql);
        $json_arr['status'] = "success";
        $json_arr['message'] = "Question removed successfully";
    ...
    public function add()
    {
        ...
        $userdata['audio'] = $this->uploadFile();
        ...
        if ($db1->table('sq_question')->insert($userdata)) {
            ...
            $json_arr['status'] = "success";
            $json_arr['id'] = $id;
            $json_arr['message'] = "Question added successfully";
        } else {
            $msg = $db1->error();
            $json_arr['status'] = "failed";
    ...
    public function edit()
    {
        ...
        $json_arr['status'] = "success";
        $json_arr['id'] = $id;
        $json_arr['message'] = "Question updated successfully";
        return json_encode($json_arr);
    ...
    public function getCategoryListByParentId($parent_id)
    {
        ...
        if (count($query->getResultArray()) >= 1) {
            ...
            $json_arr['status'] = "failed";
            $json_arr['message'] = "No more child category ";
        }
    ...
    public function removeCategory()
    {
        ...
        if ($id == "1") {
            $json_arr['status'] = "failed";
            $json_arr['message'] = "You can not remove default category";
            ...
            if (count($query->getResultArray()) == 0) {
                ...
                $query = $db1->query($sql);
                $json_arr['status'] = "success";
                $json_arr['message'] = "Category removed successfully";
            } else {
                $json_arr['status'] = "failed";
                $json_arr['message'] = "Unable to remove category! <br>There are some questions assigned to this category. Remove or move that questions to another category.";
            }
        }
        return json_encode($json_arr);
    ...
    public function addCategory()
    {
        ...
        if ($db1->table('sq_category')->insert($userdata)) {
            ...
            $json_arr['status'] = "success";
            $json_arr['id'] = $id;
            $json_arr['message'] = "Category added successfully";
            return json_encode($json_arr);
        } else {
            $msg = $db1->error();
            $json_arr['status'] = "failed";
    ...
    public function editCategory()
    {
        ...
        $json_arr['status'] = "success";
        $json_arr['id'] = $id;
        $json_arr['message'] = "Category updated successfully";
        return json_encode($json_arr);
    }
    ...
    public function uploadFile()
    {
        if ($file = $this->request->getFile('audio')) {
            if ($file->isValid() && !$file->hasMoved()) {
                ...
                return base_url("/writable/uploads/" . $newName);
            }
        }
        return null;
    }
