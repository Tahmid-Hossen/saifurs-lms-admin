...
@section('content')
    ...
    <div class="page-content-wrapper">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <!-- form start -->
                <form class="horizontal-form" id="city_form" role="form" method="POST" action="{{ route('cities.update', $city->id) }}" enctype="multipart/form-data">
                   @csrf
                    @method('PUT')
    ...
    <script>
        var selected_state_id = '{{old("state_id", (isset($city)?$city->state_id:null))}}';
        getProvinceList();
