...
/**
 * @class AssignmentCreatedNotification
...
class AssignmentCreatedNotification extends Notification
{
    ...
    /**
     * Create a new notification AssignmentCreatedNotification constructor.
    ...
    public function toDatabase($notifiableUser): array
    {
        return [
            ...
            'body' => "Your assignment submission received.Instructor will review soon.",
    ...
    public function toPush($notifiableUser): PushMessage
    {
        ...
        if(!empty($FCMToken)) :
            $pushMessage->to($FCMToken)
                ->to($FCMToken)
                ->title("Assignment Review")
                ->line("Your assignment submission received.Instructor will review soon.")
                ->image(asset('/assets/svg/assignment.svg'))
                ->type("assignment")
