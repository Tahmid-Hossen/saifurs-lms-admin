            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    @foreach($branches as $branch)
                        <option value="{{$branch->id}}" @if (isset($event) && ($event->branch_id == $branch->id)) selected @endif>{{$branch->branch_name}}</option>
                    @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <div class="img-responsive img-thumbnail bg-dark my-2 text-center"
                        ...
                        <img id="event_image_show" style="height: 206px; display: inline-block; max-width: 100%"
                             src="{{ isset($event->event_image) ? URL::to('/public/'.$event->event_image) : 'https://dummyimage.com/'.$event_banner_width.'X'.$event_banner_height.'' }}">
                    </div>
