...
// Course Manage
    ...
    Route::group(['prefix' => 'course-questions'], function () {
        Route::get('pdf', ['as' => 'course-questions.pdf', 'uses' => 'Backend\CourseManage\CourseQuestionController@pdf']);
        Route::get('excel', ['as' => 'course-questions.excel', 'uses' => 'Backend\CourseManage\CourseQuestionController@excel']);
        Route::post('get-course-question-list', ['as' => 'course.get-course-question-list', 'uses' => 'Backend\CourseManage\CourseQuestionController@getCourseQuestionList']);
    });
    Route::resource('course-questions', 'Backend\CourseManage\CourseQuestionController');

    Route::group(['prefix' => 'question-answers'], function () {
        Route::get('pdf', ['as' => 'question-answers.pdf', 'uses' => 'Backend\CourseManage\CourseQuestionAnswerController@pdf']);
        Route::get('excel', ['as' => 'question-answers.excel', 'uses' => 'Backend\CourseManage\CourseQuestionAnswerController@excel']);
    });
    Route::resource('question-answers', 'Backend\CourseManage\CourseQuestionAnswerController');
