...
class CreateCourseSubCategoryTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('course_sub_category', function (Blueprint $table) {
            ...
            $table->string('course_sub_category_slug')->nullable();
            $table->longText('course_sub_category_details')->nullable();
            $table->string('course_sub_category_image')->nullable();
            $table->string('course_sub_category_status')->nullable();
            $table->string('course_sub_category_featured')->default('No');
            $table->integer('course_sub_category_position')->nullable();
