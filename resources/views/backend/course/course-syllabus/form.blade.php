        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <textarea
                    ...
                    name="syllabus_title"
                    rows="5" required
                    class="form-control ckeditor view-color"
                    autofocus
                    placeholder="Enter Full Syllabus">{{ old('syllabus_title', isset($course_syllabus->syllabus_title) ? $course_syllabus->syllabus_title: null) }}
                </textarea>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        {!! \Form::nLabel('syllabus_status', 'Status', false) !!}
                        <select name="syllabus_status" id="syllabus_status" class="form-control view-color">
                            @foreach(\App\Support\Configs\Constants::$course_syllabus as $status)
                                <option value="{{$status}}"
                                        @if (isset($course_syllabus) && ($course_syllabus->syllabus_status === $status)) selected @endif
                                >{{str_replace("-","",$status)}}</option>
                            @endforeach
                        </select>
                        <span class="form-text text-danger" role="alert">{{ $errors->first('syllabus_status') }}</span>
                    </div>
                </div>
