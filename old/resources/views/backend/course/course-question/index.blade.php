            ...
            <div class="box box-default collapsed-box">
                ...
                <div class="box-body">
                    <form class="horizontal-form" role="form" method="GET"
                          action="{{ route('course-questions.index') }}">
                        <div class="row">
                            <div class="col-md-4">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column"
                            ...
                            @foreach($course_questions as $course_question)
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>{{isset($course_question->question)?$course_question->question:null}}</td>
                                    @role(\Utility::SUPER_ADMIN)
                                    <td style="color: #0f13d3">{{isset($course_question->company)?strtoupper($course_question->company->company_name):null}}</td>
                                    @endrole
                                    <td style="color: #76767f">{{isset($course_question->course)?$course_question->course->course_title:null}}</td>
                                    <td>
