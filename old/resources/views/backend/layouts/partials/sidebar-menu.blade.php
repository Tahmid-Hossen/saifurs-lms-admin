<ul class="sidebar-menu" data-widget="tree">
    ...
    @if(auth()->user()->can('course.index') || auth()->user()->can('course-classes.index') || auth()->user()->can('course-learns.index') ||
        auth()->user()->can('course-chapters.index') || auth()->user()->can('course-questions.index') || auth()->user()->can('question-answers.index') ||
        auth()->user()->can('course-assignments.index') || auth()->user()->can('course-batches.index') || auth()->user()->can('course-ratings.index') ||
        auth()->user()->can('enrollments.index') || auth()->user()->can('announcements.index') || auth()->user()->can('quizzes.index')
    )
        @hasanyrole('Super Admin|Admin|Management|Member|Instructor')
        <li class="treeview
            @if (
            Route::is('course.*') || Route::is('course-classes.*') ||  Route::is('course-learns.*') ||
            Route::is('course-chapters.*') || Route::is('course-questions.*') || Route::is('question-answers.*') ||
            ...
            <ul class="treeview-menu"
                @if (
                Route::is('course.*') || Route::is('course-classes.*') || Route::is('course-learns.*') ||
                Route::is('course-syllabuses.*') || Route::is('course-chapters.*') || Route::is('course-questions.*') ||
                Route::is('question-answers.*') || Route::is('course-assignments.*') || Route::is('course-batches.*') ||
                Route::is('course-ratings.*') || Route::is('enrollments.*') || Route::is('announcements.*') ||
                Route::is('quizzes.*') || Route::is('course-categories.*') || Route::is('course-sub-categories.*') ||
                Route::is('course-child-categories.*')
                )
                style="display:block;"
                @endif
            >
                ...
                @if(auth()->user()->can('course-chapters.index'))
                    ...
                    <li @if (Route::is('course-chapters.*')) class="active" @endif >
                        <a href="{{route('course-chapters.index')}}"><i class="fa fa-columns"></i> Chapter</a>
                    </li>
                    @endhasanyrole
                @endif
                ...
                @if(auth()->user()->can('course-classes.index'))
                    ...
                    <li @if (Route::is('course-classes.*')) class="active" @endif >
                        <a href="{{route('course-classes.index')}}"><i class="fa fa-laptop"></i> Class</a>
                    </li>
                    @endhasanyrole
                @endif
                ...
                {{--                @if(auth()->user()->can('course-questions.index'))
                                    @hasanyrole('Super Admin|Admin|Management|Instructor')
                                    <li @if (Route::is('course-questions.*')) class="active" @endif >
                                        <a href="{{route('course-questions.index')}}"><i class="fa fa-question-circle"></i> Question</a>
                                    </li>
                                    @endhasanyrole
                                @endif

                                @if(auth()->user()->can('question-answers.index'))
                                    @hasanyrole('Super Admin|Admin|Management|Instructor')
                                    <li @if (Route::is('question-answers.*')) class="active" @endif >
                                        <a href="{{route('question-answers.index')}}"><i class="fa fa-reply-all"></i> Answer</a>
                                    </li>
                                    @endhasanyrole
                                @endif--}}
...
<!-- Sales -->
    ...
    @if(auth()->user()->can('countries.index') || auth()->user()->can('cities.index') || auth()->user()->can('vendors.index') ||
        ...
        <li class="treeview @if (
            ...
            ">
            <a href=" #">
                <i class="fa fa-cogs"></i> <span>Setting Manage</span>
                <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
        </span>
            </a>
