var api_base_url = "https://admin.saifurs.com.bd/public/quiz/api/";
var api_site_url = "https://admin.saifurs.com.bd/public/quiz/api/quiz.php/";
    ...
    $.post(api_site_url + "user/getList", arg, function (data) {
        ...
        if (result.status == "success") {
            ...
            $(result.data).each(function (index, value) {
                ...
                var hiddenRow = "<tr><td><input type='checkbox' class='selectRow' value='" + value.id + "'></td><td>" + value.id + "</td><td>" + value.username + "</td><td>" + value.email + "</td><td>" + value.name + "</td><td>" + value.group_name + "</td><td>" + value.account_name + "</td><td>" + dropDownAction + "</td></tr>";
...
function sq_category_parent(pid) {
    ...
    $.post(api_site_url + "Qbank/getCategoryListByParentId/" + pid, arg, function (data) {
        var result = JSON.parse(data.trim());
        if (result.status == "success") {
            var selectEle = "<div class='col-md-4'> <select name='category_id' class='category_id form-control custom-select ' id='pid-" + pid + "' onchange=sq_category_parent(this.value) ><option value='0'>Select Category</option>";
            $(result.data).each(function (index, value) {
                selectEle = selectEle + "<option value='" + value.id + "'>" + value.category_name + "</option>";

            });
            if (document.getElementById('pid-' + pid) == undefined) {
                selectEle += '</select></div>';
...
function sq_category_parent3(pid) {
    ...
    $.post(api_site_url + "Qbank/getCategoryListByParentId/" + pid, arg, function (data) {
        var result = JSON.parse(data.trim());
        if (result.status == "success") {
            var selectEle = "<div class='col-md-4'> <select name='category_id3' class='category_id3 form-control custom-select ' id='pid3-" + pid + "' onchange=sq_category_parent3(this.value) ><option value='0'>Select Category</option>";
            $(result.data).each(function (index, value) {
                selectEle = selectEle + "<option value='" + value.id + "'>" + value.category_name + "</option>";
...
function sq_category_parent4(pid) {
    ...
    $.post(api_site_url + "Qbank/getCategoryListByParentId/" + pid, arg, function (data) {
        var result = JSON.parse(data.trim());
        if (result.status == "success") {
            var selectEle = "<div class='col-md-4'> <select name='category_id4' class='category_id4 form-control custom-select ' id='pid4-" + pid + "' onchange=sq_category_parent4(this.value) ><option value='0'>Select Category</option>";
            $(result.data).each(function (index, value) {
                selectEle = selectEle + "<option value='" + value.id + "'>" + value.category_name + "</option>";
...
function sq_category_parentEdit(pid) {
    ...
    $.post(api_site_url + "Qbank/getCategoryListByParentId/" + pid, arg, function (data) {
        var result = JSON.parse(data.trim());
        if (result.status == "success") {
            var selectEle = "<div class='col-md-4'> <select name='category_id' class='category_id form-control custom-select ' id='pid-" + pid + "' onchange=sq_category_parentEdit(this.value) ><option value='0'>Select Category</option>";
            $(result.data).each(function (index, value) {
                selectEle = selectEle + "<option value='" + value.id + "'>" + value.category_name + "</option>";
            });
            if (document.getElementById('pid-' + pid) == undefined) {
...
function submitAddQuestion() {
    ...
    tempFormData = new FormData(document.getElementById('form-1'));
    }
    else if (question_type === "Multiple Choice Multiple Answers") {
        tempFormData = new FormData(document.getElementById('form-2'));
    }
    else if (question_type === "Short Answer") {
        tempFormData = new FormData(document.getElementById('form-3'));
    }
    else if (question_type === "Long Answer") {
        tempFormData = new FormData(document.getElementById('form-4'));
    } else {
    ...
    for(var pair of tempFormData.entries()) {
        if(pair[0] === 'audio') {
            fData.append('audio', pair[1]);
        }
        else {
            question.push({'name': pair[0], 'value': pair[1]});
        }
    }

    fData.append('user_token', localStorage.getItem('user_token'));
    fData.append('category_id', category_id);
    fData.append('question_type', question_type);
    fData.append('fData', JSON.stringify(question));

    $.ajax({
        url: api_site_url + "qbank/add",
        method: 'post',
        data: fData,
        contentType: false,
        processData: false,
...
function editQuiz(contrl, mid, id) {
    ...
    $.post(api_site_url + "user/getGroupList", arg2, function (data) {
        ...
        if (result.status == "success") {
            $(result.data).each(function (index, value) {
                var d = "<input type='checkbox' class='editQuizGids' value='" + value.id + "' name='gids[" + value.id + "]'> " + value.group_name + "<br>";
    ...
    $.post(api_site_url + "quiz/getList", arg, function (data) {
        ...
        if (result.status == "success") {
            $(result.data).each(function (index, value) {
                ...
                $('.edit-course-select').each(function () {
                    $(this).val(value.course_id);
                });
...
function getQuestionListQuiz(p) {
    ...
    if (search != "") {
        ...
        arg = {
            ...
            limit: rowLimit,
            cid: cid,
            showAssignedQuestions: showAssignedQuestions,
        ...
        $.post(api_site_url + "quiz/" + uri, arg, function (data) {
            ...
            if (result.status == "success") {
                $(result.data).each(function (index, value) {
                    ...
                    try {
                        $('#noq').html(value.qids.split(',').length);
                    } catch (ex) {
                        $('#noq').html('0');
                    }
                    $('.spinner-border').hide();
        ...
        $.post(api_site_url + "result/view", arg, function (data) {
            ...
            if (result.status == "success") {
                ...
                const arg = {
                    ...
                    ind_time: result.data.ind_time,
                    ind_score: result.data.ind_score,
                    attempted_questions: result.data.attempted_questions
                };
        ...
        $.post(api_site_url + "result/" + uri, arg, function (data) {
            ...
            if (result.status == "success") {
                $(result.data).each(function (index, value) {
                    ...
                    var hiddenRow = "<tr><td>" + value.id + "</td><td>" + value.username + "</td><td>" + value.full_name + "</td><td>" + value.course_title + "</td><td>" + value.quiz_name + "</td><td>" + value.result_status + "</td><td>" + value.obtained_percentage + "%</td><td>" + dropDownAction + "</td></tr>";
        ...
        $.post(api_site_url + "user/myInfo", arg, function (data) {
            ...
            if (result.status == "success") {
                $(result.data).each(function (index, value) {
                    ...
                    $('#sq_user-username-edit').val(value.username);
                    $('#sq_user-email-edit').val(value.email);
                    $('#sq_user-full_name-edit').val(value.name);
                });
            }
        });
...
function getCourseList(dropdownID = null) {
    $("#course_select").empty();
    courseDropdown = "<select name='course_id' class='form-control custom-select edit-course-select' required>";
    $.post(api_site_url + "quiz/getCourses", {user_token: localStorage.getItem('user_token')}, function (data) {
        var result = JSON.parse(data);
        if (result.status == "success")
            $(result.data).each(function (index, value) {
                courseDropdown += "<option value='" + value.id + "'>" + value.course_title + "</option>";
            });
        else
            courseDropdown += "<option value=''>No Course Found</option>";

        courseDropdown += "</select>";
        $(".course_select").each(function () {
            $(this).append(courseDropdown);
        });
    });
}
