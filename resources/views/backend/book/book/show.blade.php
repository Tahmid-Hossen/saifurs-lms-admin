                ...
                <div class="box-body">
                    ...
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            ...
                            @if(isset($book->file))
                            <li><a href="#tab_3" data-toggle="tab">Preview PDF</a></li>
                            @endif
                        </ul>
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab_1">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <p>
                                                {{ ucfirst(strtolower($book->country)) ?? null }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="control-label">Author Details</label><br>
                                            <div class="container-fluid"
                                                 style="border: 2px solid #d2d6de; min-height: 200px">
                                                {!! html_entity_decode($book->author_info) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
